...
<div class="home width-full text-wrap-pretty">
  <div class="home-hero width-full">
    <div
      class="display-flex flex-direction-column prose width-full max-width-section padding-2 tablet:padding-inline-4"
    >
      <RotatingEyebrow />
    ...
    <div
      class="hero-footer display-flex flex-direction-column prose width-full max-width-section padding-2 tablet:padding-inline-4"
    >
      <a class="font-code text-lg" href="#about-zebkit"
  ...
  <div
    ...
    class="display-flex flex-direction-column prose width-full max-width-section padding-2 tablet:padding-inline-4"
  >
    <p class="lede margin-block-start-2">
    ...
    <p class="sub">
      ...
      can swap. Change the tokens and the whole product takes on <em>your look</em>: same HTML, same behavior, <em>new everything</em>.
    </p>
  </div>
  <svg
