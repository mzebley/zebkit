...
>
  ...
  <p class="lede">
    ...
    <code>--zbk-color-&lt;family&gt;-&lt;step&gt;</code>. Primitives are the raw material — semantic
    tokens alias them, and components reference the semantic layer, never these directly.
  </p>
