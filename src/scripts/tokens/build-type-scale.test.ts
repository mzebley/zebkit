  ...
  return {
    [KEY]: {
      ...
      md: {
        ...
        $type: "rootFontSize",
        $description: "Base.",
        $extensions: { "dev.zebkit": { a11y: "--zbk-a11y-font-size-modifier-md" } },
      } as unknown as TokenInterface[string],
      "3xs": {
        index: -4,
        $type: "rootFontSize",
        $description: "Smallest.",
        $extensions: { "dev.zebkit": { a11y: "--zbk-a11y-font-size-modifier-3xs" } },
      } as unknown as TokenInterface[string],
      lg: {
        index: 1,
        $type: "rootFontSize",
        $description: "Large.",
        $extensions: { "dev.zebkit": { a11y: "--zbk-a11y-font-size-modifier-lg" } },
      } as unknown as TokenInterface[string],
    },
  };
}
