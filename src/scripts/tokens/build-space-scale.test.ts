...
function makeTokens(): Record<string, TokenInterface> {
  return {
    ...
    [SPACING]: {
      ...
      "05": { value: "0.5rem", type: "rootSize", description: "Tiny.", a11y: true } as unknown as TokenInterface[string],
      // Macro floor (== MACRO_ANCHOR): curve growth reaches the full max-scale.
      "16": { value: "16rem", type: "rootSize", description: "Macro.", a11y: true } as unknown as TokenInterface[string],
      // Per-token override: pins growth, bypassing the curve.
      pinned: { value: "1rem", type: "rootSize", description: "Pinned.", a11y: true, growth: 1.5 } as unknown as TokenInterface[string],
