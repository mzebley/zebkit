...
const tokens = {
  ...
  "ink-strong": {
    value: "",
    type: "color",
    description: "Strong action ink color for high-emphasis text and icons."
  },
  ...
  "ink-inverse-strong": {
    value: "",
    type: "color",
    description: "Strong inverse action ink color for high-emphasis text and icons on inverse canvases."
  },
