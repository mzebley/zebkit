...
const tokens = {
  ...
  "ink-strong": {
    value: "",
    type: "color",
    description: "Strong positive ink color for high-emphasis text and icons."
  },
  ...
  "ink-inverse-strong": {
    value: "",
    type: "color",
    description: "Strong inverse positive ink color for high-emphasis text and icons on inverse canvases."
  },
