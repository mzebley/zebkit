...
const tokens = {
  ...
  "3xs": {
    ...
    $extensions: { "dev.zebkit": { a11y: `--${ZEBKIT_PREFIX}-a11y-font-size-modifier-3xs` } },
  },
  "2xs": {
    index: -3,
    $type: "rootFontSize",
    $description: "Second smallest font size.",
    $extensions: { "dev.zebkit": { a11y: `--${ZEBKIT_PREFIX}-a11y-font-size-modifier-2xs` } },
  },
  xs: {
    index: -2,
    $type: "rootFontSize",
    $description: "Extra small font size.",
    $extensions: { "dev.zebkit": { a11y: `--${ZEBKIT_PREFIX}-a11y-font-size-modifier-xs` } },
  },
  sm: {
    index: -1,
    $type: "rootFontSize",
    $description: "Small font size.",
    $extensions: { "dev.zebkit": { a11y: `--${ZEBKIT_PREFIX}-a11y-font-size-modifier-sm` } },
  },
  md: {
    index: 0,
    $type: "rootFontSize",
    $description: "Base / body font size.",
    $extensions: { "dev.zebkit": { a11y: `--${ZEBKIT_PREFIX}-a11y-font-size-modifier-md` } },
  },
  lg: {
    index: 1,
    $type: "rootFontSize",
    $description: "Large font size.",
    $extensions: { "dev.zebkit": { a11y: `--${ZEBKIT_PREFIX}-a11y-font-size-modifier-lg` } },
  },
  xl: {
    index: 2,
    $type: "rootFontSize",
    $description: "Extra large font size.",
    $extensions: { "dev.zebkit": { a11y: `--${ZEBKIT_PREFIX}-a11y-font-size-modifier-xl` } },
  },
  "2xl": {
    index: 3,
    $type: "rootFontSize",
    $description: "Double extra large font size.",
    $extensions: { "dev.zebkit": { a11y: `--${ZEBKIT_PREFIX}-a11y-font-size-modifier-2xl` } },
  },
  "3xl": {
    index: 4,
    $type: "rootFontSize",
    $description: "Triple extra large font size.",
    $extensions: { "dev.zebkit": { a11y: `--${ZEBKIT_PREFIX}-a11y-font-size-modifier-3xl` } },
  },
  "4xl": {
    index: 5,
    $type: "rootFontSize",
    $description: "Quadruple extra large font size.",
    $extensions: { "dev.zebkit": { a11y: `--${ZEBKIT_PREFIX}-a11y-font-size-modifier-4xl` } },
  },
  "5xl": {
    index: 6,
    $type: "rootFontSize",
    $description: "Quintuple extra large font size.",
    $extensions: { "dev.zebkit": { a11y: `--${ZEBKIT_PREFIX}-a11y-font-size-modifier-5xl` } },
  },
