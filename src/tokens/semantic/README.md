...
Author a semantic module through the parent [token-module guide](../README.md). The [manifesto's token strata](../../../VISION.md#the-token-strata-a-theory-of-change) define when an alias is the right layer; component-only decisions belong in the component token surface instead.
