...
const tokens = {
  ...
  "playful-motion-function-default": {
    $value: `cubic-bezier(0.38, 1.21, 0.22, 1.00)`,
    $type: "transition",
    $description:
  ...
  "playful-motion-function-slow": {
    $value: `cubic-bezier(0.39, 1.29, 0.35, 0.98)`,
    $type: "transition",
    $description:
  ...
  "playful-motion-function-fast": {
    $value: `cubic-bezier(0.42, 1.67, 0.21, 0.90)`,
    $type: "transition",
    $description:
  ...
  "playful-fx-function-default": {
    $value: `cubic-bezier(0.34, 0.80, 0.34, 1.00)`,
    $type: "transition",
    $description:
  ...
  "playful-fx-function-slow": {
    $value: `cubic-bezier(0.34, 0.88, 0.34, 1.00)`,
    $type: "transition",
    $description:
  ...
  "playful-fx-function-fast": {
    $value: `cubic-bezier(0.31, 0.94, 0.34, 1.00)`,
    $type: "transition",
    $description:
  ...
  "calm-motion-function-default": {
    $value: `cubic-bezier(0.27, 1.06, 0.18, 1.00)`,
    $type: "transition",
    $description:
...
} as const satisfies SemanticTransitionTokens;
